...
/* David Vernon  
                                                                        */ 
/*  modified the code a bit at the end                                                                    */
/************************************************************************/
...
int assign_element_values(ELEMENT_TYPE *e, int number, long int mytime) {
...
void enqueue(ELEMENT_TYPE e, LIST_TYPE *list){
	insert(e,end(list),list);
}
ELEMENT_TYPE dequeue(LIST_TYPE *list){
	if(is_empty(list)){   //check to see if the the list is empty before dequeue
		printf("nothing in list \n");
	}
	else {
		ELEMENT_TYPE e = retrieve(first(list),list);
		delete_element(first(list),list);
		return e; // added for it to return the removed element
	}
}
